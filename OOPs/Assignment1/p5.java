...
public class p5 {
    public static void main(String[] args) {
        ...
        int average = holiday.avgDate(holidays);
        System.out.println("Average Day of Holidays: " + average);
    }
}
...
class holiday{
    ...
    public boolean inSameMonth(holiday h) {
        if (this.month.equalsIgnoreCase(h.month)) {
            return true;
        } else {
            return false;
        }
    ...
    public static int avgDate(holiday[] holidays) {
        int sum = 0;
